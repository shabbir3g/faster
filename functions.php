...
function faster_widgets_init() {
	register_sidebar( array(
		...
		'before_widget' => '<div id="gestion_formations" class="blockSidebar myriadPro">',
		'after_widget'  => '</div>',
		'before_title'  => '<div class="nycd actuTitle"><h2>',
		'after_title'   => '</h2></div>',
	) );
}
...
function faster_scripts() {
	...
	wp_enqueue_style( 'faster-awesome', get_template_directory_uri() . '/css/font-awesome.min.css');
	wp_enqueue_style( 'faster-restyle', get_template_directory_uri() . '/css/style.css');
	
	wp_enqueue_style( 'faster-style', get_stylesheet_uri() );
	
	wp_enqueue_style( 'faster-responsive', get_template_directory_uri() . '/css/responsive.css');
	...
	wp_enqueue_script( 'faster-jquery', get_template_directory_uri() . '/js/jquery.js', '', '', true );
	
	wp_enqueue_script( 'faster-script', get_template_directory_uri() . '/js/script.js', array('faster-jquery'), '', true );
